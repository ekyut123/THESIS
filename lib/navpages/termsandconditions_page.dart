          ...
          child: Column(
            children: [
              ...
              const Padding(
                padding: EdgeInsets.fromLTRB(60, 5, 30, 0),
                child: Text(
                  "6.1 Consumers shall pay all Consumer Fees for all services made available through the Application in full using the method chosen at the time of booking, which may be on-site or one of the automated payment options offered on the Application. Any payment made in accordance with such a choice is non-refundable and final.",
                  textAlign: TextAlign.justify,
                  style: TextStyle(
                    fontSize: 15.0,
                    fontWeight: FontWeight.w300,
              ...
              const Padding(
                padding: EdgeInsets.fromLTRB(60, 5, 30, 0),
                child: Text(
                  "6.2 Any transaction of the Consumers and Partners SRVCS doesn’t have any accountabilities.",
                  textAlign: TextAlign.justify,
                  style: TextStyle(
                    fontSize: 15.0,
                    fontWeight: FontWeight.w300,
              ...
              const Padding(
                padding: EdgeInsets.fromLTRB(60, 5, 30, 0),
                child: Text(
                  "7.1.1. If the consumer decides to cancel the appointment, they can only cancel the booked service twenty-four (24) hours prior to the booked schedule. ",
                  textAlign: TextAlign.justify,
                  style: TextStyle(
                    fontSize: 15.0,
                    fontWeight: FontWeight.w300,
              ...
              const Padding(
                padding: EdgeInsets.fromLTRB(28, 5, 225, 0),
                child: Text(
                  "8.1 For Consumers:",
                  style: TextStyle(
                    fontSize: 15.0,
              ...
              const Padding(
                padding: EdgeInsets.fromLTRB(60, 5, 30, 0),
                child: Text(
                  "8.1.1. If the consumer decides to reschedule the appointment,  they can only reschedule the booked service twenty-four (24) hours prior to the booked schedule.",
                  textAlign: TextAlign.justify,
                  style: TextStyle(
                    fontSize: 15.0,
                    fontWeight: FontWeight.w300,
              ...
              const Padding(
                padding: EdgeInsets.fromLTRB(60, 5, 30, 0),
                child: Text(
                  "9.2. You grant SRVCS a royalty-free and non-exclusive license to display, use, copy, transmit, and broadcast the content you upload and publish. For issues regarding intellectual property claims, you should contact the company in order to come to an agreement.",
                  textAlign: TextAlign.justify,
                  style: TextStyle(
                    fontSize: 15.0,
                    fontWeight: FontWeight.w300,
              ...
              const Padding(
                padding: EdgeInsets.fromLTRB(60, 5, 30, 0),
                child: Text(
                  "12.1. SRVCS may contain links to third-party websites or services that are not owned or controlled by SRVCS.",
                  textAlign: TextAlign.justify,
                  style: TextStyle(
                    fontSize: 15.0,
                    fontWeight: FontWeight.w300,
              ...
              const Padding(
                padding: EdgeInsets.fromLTRB(60, 5, 30, 0),
                child: Text(
                  "12.1. We strongly advise You to read the terms and conditions and privacy policies of any third-party web sites or services that You visit.",
                  textAlign: TextAlign.justify,
                  style: TextStyle(
                    fontSize: 15.0,
                    fontWeight: FontWeight.w300,
              ...
              const Padding(
                padding: EdgeInsets.fromLTRB(60, 5, 30, 0),
                child: Text(
                  "13.1. Upon termination, your right to use SRVCS will cease immediately. If you wish to terminate Your Account, you may simply discontinue using the SRVCS.",
                  textAlign: TextAlign.justify,
                  style: TextStyle(
                    fontSize: 15.0,
                    fontWeight: FontWeight.w300,
