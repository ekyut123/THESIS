...
class HealthCareList extends StatefulWidget {
  ...
  const HealthCareList({super.key, required this.label, required this.uid});
          ...
          if (snapshot.hasData) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                return healthcareData[index].isSubbed
                    ? GestureDetector(
                        onTap: () {
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (BuildContext context) =>
                                      BusinessPage(
                                          chosenbusiness: healthcareData[index]
                                              .businessid)));
                        },
                        child: Container(
                          ...
                          child: ListTile(
                              ...
                              subtitle: Text(
                                  healthcareData[index].businessDescription)),
                        ),
                      )
                    : Container();
              },
